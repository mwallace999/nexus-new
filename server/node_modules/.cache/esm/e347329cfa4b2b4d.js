let express,http,Server,createBoard;_fa4‍.w("express",[["default",["express"],function(v){express=v}]]);_fa4‍.w("http",[["default",["http"],function(v){http=v}]]);_fa4‍.w("socket.io",[["Server",["Server"],function(v){Server=v}]]);_fa4‍.w("./controller/board",[["createBoard",["createBoard"],function(v){createBoard=v}]]);
...
io.on('connection', (socket) => {
    ...
    _fa4‍.g.console.log('ROOMS', dataStore.rooms);
